...
- [Passing Secrets to AWS Parametere Store](#passing-secrets-to-aws-parametere-store)
- [Create CloudWatch Log Group, ECS Cluster and Repository](#create-cloudwatch-log-group-ecs-cluster-and-repository)
- [Build and Push to ECR backend/frontend images](#build-and-push-to-ecr-backendfrontend-images)
- [1. Push Python base-image](#1-push-python-base-image)
- [2. Build and Push backend-flask image](#2-build-and-push-backend-flask-image)
- [3. Build and Push frontend-react-js image](#3-build-and-push-frontend-react-js-image)
- [AWS Roles and Security Groups](#aws-roles-and-security-groups)
- [Create Tasks and Services definitions for ECS](#create-tasks-and-services-definitions-for-ecs)
- [Create Security Group for ECS](#create-security-group-for-ecs)
- [Test Container Service Connection](#test-container-service-connection)
...
## 2. Build and Push backend-flask image
...
## 3. Build and Push frontend-react-js image
